        ...
        <div class="center-align">
            ...
            <form method="POST" action="buscaProduto.php">
                <div class="col s12 m6 push-m3 ">
                    ...
                    <button type="submit" class="btn-floating btn-large waves-effect waves-light green"><i class="material-icons">search</i></button>
                    <a href="cadastrarProduto.php" class="btn-floating  btn-large waves-effect waves-light green"><i class="material-icons">add</i></a>
